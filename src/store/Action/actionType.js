...
export const PURCHASE_BURGER_START= ' PURCHASE_BURGER_START' //for setting loader
export const PURCHASE_BURGER_SUCCESS = 'PURCHASE_BURGER_SUCCESS';
export const PURCHASE_BURGER_FAILED= 'PURCHASE_BURGER_FAILED';
export const PURCHASE_INIT = 'PURCHASE_INIT'; //For Redirecting when Order finished
